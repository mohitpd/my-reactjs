    ...
    return (
        <Formik
            ...
            validationSchema={Yup.object({
                firstname: Yup.string().required('Sorry, this is required').max(6, 'Sorry the name is too long'),
                lastname: Yup.string().required('Sorry, this is required').max(6, 'Sorry the name is too long'),
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className='row'>
                                <div className='col-md-5 mb-3'>
                                    ...
                                    <select className='custom-select d-block w-100' id='country' name='country' value={values.country} onChange={handleChange}>
                                ...
                                <div className='col-md-4 mb-3'>
                                    ...
                                    <select className='custom-select d-block w-100' id='state' name='state' value={values.state} onChange={handleChange}>
                                        <option value=''>Choose...</option>
                                ...
                                <div className='col-md-3 mb-3'>
                                    ...
                                    <input type='text' className='form-control' id='zip' name='zip' value={values.zip} onChange={handleChange} />
                                </div>
                            </div>
